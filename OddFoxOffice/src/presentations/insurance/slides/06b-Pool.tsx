...
/* Two ideas in one figure, because they only make sense together.
  ...
  return (
    <Slide align="start">
      ...
      <svg viewBox="0 0 1180 340" style={{ width: "100%", height: "auto", marginTop: "0.5rem" }}
        ...
        {/* ---------- right: who pays as the claim grows ---------- */}
        {STEPS.map((s, i) => {
          const x = x0 + i * stepW;
          return (
            <g key={s.who}>
        ...
        {/* Sits outside the last box: right-aligned inside it collided with that
            box's own left-hand threshold label. */}
